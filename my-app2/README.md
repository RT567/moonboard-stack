...
* [`src/my_app2/styles.cljs`](src/my_app2/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/my_app2/`](src/my_app2/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/my_app2/core.cljs): contains the SPA entry point, `init`
* [`test/my_app2/`](test/my_app2/): test files (ClojureScript,
...
(headless test environment)
    * For Chromium, set the `CHROME_BIN` environment variable in your shell to the command that
    launches Chromium. For example, in Ubuntu, add the following line to your `.bashrc`:
       ...
       ```
5. Clone this repo and open a terminal in the `my-app2` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/my_app2/config.cljs) defaults to `true` in
...
```clj
(ns my-app2.example
  (:require [my-app2.config :as config])
